...
class FormaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de forma");
        ...
        $row1 = $this->form->addFields([new TLabel("Código", '#ff0000', '14px', 'B', '100%'),$id],[new TLabel("Descrição", '#ff0000', '14px', 'B', '100%'),$descricao]);
    ...
    public function onSave($param = null)
    {
        try
        {
            ...
            **/
            ...
            $messageAction = new TAction(['FormaForm', 'onClear']);
