...
class FormaList extends TPage
{
    ...
    private static $formName = 'formList_Forma';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de formas");
        ...
        $row1 = $this->form->addFields([new TLabel("Código", null, '14px', null, '100%'),$id],[new TLabel("Descrição", null, '14px', null, '100%'),$descricao]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['FormaForm', 'onShow']), 'fas:plus #ffffff');
        ...
        $action_onEdit = new TDataGridAction(array('FormaForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FormaList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastros","Formas de Pagamento"]));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Forma
