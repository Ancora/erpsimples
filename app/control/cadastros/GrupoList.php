...
class GrupoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Grupos de Pessoas");
        ...
        $column_data_registro_transformed = new TDataGridColumn('data_registro', "Cadastrado em", 'center' , '20%');
        ...
        $action_onDelete = new TDataGridAction(array('GrupoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastros","Grupos de Pessoas"]));
