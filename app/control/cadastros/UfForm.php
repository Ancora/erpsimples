...
class UfForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Código", null, '14px', null, '100%'),$id],[new TLabel("Descrição", '#ff0000', '14px', 'B', '100%'),$descricao],[new TLabel("Sigla", '#ff0000', '14px', 'B', '100%'),$sigla]);
    ...
    public function onSave($param = null)
    {
        try
        {
            ...
            **/
            ...
            $messageAction = new TAction(['UfForm', 'onClear']);
