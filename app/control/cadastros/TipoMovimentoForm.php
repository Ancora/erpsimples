...
class TipoMovimentoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de Tipos de Movimentos");
        ...
        $tipo_estoque->setSize('100%');
        $data_registro->setSize('100%');
        $usuario_registro->setSize('100%');
        $data_atualizacao->setSize('100%');
        $usuario_atualizacao->setSize('100%');

        $row1 = $this->form->addFields([new TLabel("Código", '#ff0000', '14px', 'B', '100%'),$id],[new TLabel("Descrição", '#ff0000', '14px', 'B', '100%'),$descricao],[new TLabel("Sigla", '#ff0000', '14px', 'B', '100%'),$sigla],[new TLabel("Tipo", '#ff0000', '14px', 'B', '100%'),$tipo_estoque]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $messageAction = new TAction(['TipoMovimentoForm', 'onClear']);
