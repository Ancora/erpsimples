...
class TipoProdutoList extends TPage
{
    ...
    private static $formName = 'formList_TipoProduto';
    ...
    public function __construct()
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Cadastrados de ...", null, '14px', null, '100%'),$data_registro_ini],[new TLabel("... até", null, '14px', null, '100%'),$data_registro_fim],[new TLabel("Cadastrados por", null, '14px', null, '100%'),$usuario_registro]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['TipoProdutoForm', 'onShow']), 'fas:plus #ffffff');
        ...
        $column_id = new TDataGridColumn('id', "Código", 'center' , '65.8px');
        $column_descricao = new TDataGridColumn('descricao', "Descrição", 'left' , '45%');
        ...
        $column_usuario_registro = new TDataGridColumn('usuario_registro', "Usuário", 'left' , '15%');
        ...
        $action_onDelete = new TDataGridAction(array('TipoProdutoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastros","Tipos de Produtos"]));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TipoProduto($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TipoProduto
