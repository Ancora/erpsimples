...
class TipoMovimentoList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_TipoMovimento';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Tipos de Movimentos");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['TipoMovimentoForm', 'onShow']), 'fas:plus #ffffff');
        ...
        $column_data_registro_transformed = new TDataGridColumn('data_registro', "Data do Cadastro", 'center' , '19%');
        ...
        $action_onEdit = new TDataGridAction(array('TipoMovimentoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TipoMovimentoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastros","Tipos de Movimentos"]));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TipoMovimento($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TipoMovimento
